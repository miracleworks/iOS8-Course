...
class Factory
{
    ...
    class func CreateSlots() -> [[Slot]]
    {
        ...
        var slots: [[Slot]] = []
        // slots = [ [slot1,slot2], [slot3,slot4], [slot6] ]
        // mySlotArray = slot[1]
        // slot = mySlotArray[1] gives slot4
    ...
    class func createSlot(currentCards: [Slot]) -> Slot
    {
        ...
        {
            randomNumber = Int(arc4random_uniform(UInt32(13))) // reassign a randomnumber as current random number already found in currentcardvalues
        }
